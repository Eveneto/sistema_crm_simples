...
-- =====================================================
-- PASSO 3: Criar Deals de Teste (Variados)
-- =====================================================

-- Deals GANHOS (últimos 3 meses) - para cálculo de receita realizada
INSERT INTO deals (
  ...
  ('Consultoria Marketing Digital', 'Consultoria mensal por 6 meses', 'c3333333-3333-3333-3333-333333333333', :'stage_won', 'won',
   42000, 100, '2024-11-10', :'user_id', :'user_id', 'won',
   '2024-10-15', '2024-11-10', '2024-11-10'),
   
  ('Sistema CRM Customizado', 'Desenvolvimento de CRM sob medida', 'c5555555-5555-5555-5555-555555555555', :'stage_won', 'won',
   85000, 100, '2024-11-25', :'user_id', :'user_id', 'won',
   '2024-09-10', '2024-11-25', '2024-11-25'),
   
  ('App Mobile iOS/Android', 'Desenvolvimento de aplicativo', 'c8888888-8888-8888-8888-888888888888', :'stage_won', 'won',
   120000, 100, '2024-11-20', :'user_id', :'user_id', 'won',
   '2024-08-15', '2024-11-20', '2024-11-20'),
   
  -- Outubro 2024 - Deals ganhos
  ('Redesign UI/UX', 'Redesign completo de plataforma', 'ca000000-0000-0000-0000-000000000000', :'stage_won', 'won',
   28000, 100, '2024-10-18', :'user_id', :'user_id', 'won',
   '2024-09-01', '2024-10-18', '2024-10-18'),
   
  ('Automação de Marketing', 'Setup e automação HubSpot', 'cc000000-0000-0000-0000-000000000000', :'stage_won', 'won',
   18500, 100, '2024-10-12', :'user_id', :'user_id', 'won',
   '2024-09-20', '2024-10-12', '2024-10-12'),
   
  ('E-commerce Completo', 'Loja virtual + integração pagamento', 'cf000000-0000-0000-0000-000000000000', :'stage_won', 'won',
   65000, 100, '2024-10-25', :'user_id', :'user_id', 'won',
   '2024-08-10', '2024-10-25', '2024-10-25'),
   
  -- Setembro 2024 - Deals ganhos
  ('Landing Page + Ads', 'LP para campanha + gestão Google Ads', 'c6666666-6666-6666-6666-666666666666', :'stage_won', 'won',
   12000, 100, '2024-09-15', :'user_id', :'user_id', 'won',
   '2024-08-25', '2024-09-15', '2024-09-15'),
   
  ('Dashboard Analytics', 'Dashboard customizado BI', 'cd000000-0000-0000-0000-000000000000', :'stage_won', 'won',
   32000, 100, '2024-09-22', :'user_id', :'user_id', 'won',
   '2024-07-10', '2024-09-22', '2024-09-22');

-- Deals ATIVOS - Em NEGOCIAÇÃO (para forecast)
INSERT INTO deals (
  title, description, contact_id, stage_id, stage,
  value, probability, expected_close_date,
  user_id, assigned_to, status,
  ...
  ('ERP Enterprise', 'Sistema ERP completo', 'c2222222-2222-2222-2222-222222222222', :'stage_proposal', 'negotiation',
   250000, 85, '2024-12-15', :'user_id', :'user_id', 'active',
   '2024-10-01', NOW()),
   
  ('Consultoria DevOps', 'Consultoria migração cloud', 'c4444444-4444-4444-4444-444444444444', :'stage_proposal', 'negotiation',
   45000, 80, '2024-12-20', :'user_id', :'user_id', 'active',
   '2024-10-15', NOW()),
   
  -- Média probabilidade (50-70%)
  ('Sistema Gestão Estoque', 'WMS customizado', 'c7777777-7777-7777-7777-777777777777', :'stage_qualified', 'qualified',
   78000, 60, '2025-01-10', :'user_id', :'user_id', 'active',
   '2024-11-01', NOW()),
   
  ('App Delivery', 'Aplicativo delivery comida', 'c9999999-9999-9999-9999-999999999999', :'stage_qualified', 'qualified',
   95000, 65, '2025-01-20', :'user_id', :'user_id', 'active',
   '2024-10-20', NOW()),
   
  ('Portal Corporativo', 'Intranet + gestão documentos', 'cb000000-0000-0000-0000-000000000000', :'stage_proposal', 'proposal',
   52000, 70, '2024-12-28', :'user_id', :'user_id', 'active',
   '2024-11-05', NOW()),
   
  -- Baixa probabilidade (30-40%)
  ('Site E-learning', 'Plataforma cursos online', 'ce000000-0000-0000-0000-000000000000', :'stage_qualified', 'qualified',
   38000, 40, '2025-02-15', :'user_id', :'user_id', 'active',
   '2024-11-10', NOW()),
   
  ('Integração APIs', 'Integração múltiplos sistemas', 'c0000001-0000-0000-0000-000000000000', :'stage_lead', 'lead',
   22000, 30, '2025-02-28', :'user_id', :'user_id', 'active',
   '2024-11-15', NOW()),
   
  ('App Fitness', 'Aplicativo treinos personalizados', 'c0000002-0000-0000-0000-000000000000', :'stage_qualified', 'qualified',
   48000, 50, '2025-01-25', :'user_id', :'user_id', 'active',
   '2024-11-08', NOW()),
   
  ('SaaS B2B', 'Plataforma SaaS multi-tenant', 'c0000003-0000-0000-0000-000000000000', :'stage_proposal', 'proposal',
   180000, 75, '2025-01-15', :'user_id', :'user_id', 'active',
   '2024-09-20', NOW()),
   
  ('Marketplace', 'Marketplace produtos artesanais', 'c0000004-0000-0000-0000-000000000000', :'stage_qualified', 'qualified',
   110000, 55, '2025-02-10', :'user_id', :'user_id', 'active',
   '2024-10-25', NOW());

-- Deals PERDIDOS (para cálculo de win rate)
INSERT INTO deals (
  title, description, contact_id, stage_id, stage,
  value, probability, expected_close_date,
  user_id, assigned_to, status,
  ...
  ('Projeto MVP', 'MVP para startup', 'c0000005-0000-0000-0000-000000000000', :'stage_lost', 'lost',
   35000, 0, '2024-11-10', :'user_id', :'user_id', 'lost',
   '2024-10-01', '2024-11-05', '2024-11-05'),
   
  ('Refatoração Legacy', 'Refatoração sistema legado', 'c1111111-1111-1111-1111-111111111111', :'stage_lost', 'lost',
   58000, 0, '2024-10-20', :'user_id', :'user_id', 'lost',
   '2024-09-10', '2024-10-18', '2024-10-18'),
   
  ('Consultoria SEO', 'Auditoria e consultoria SEO', 'c3333333-3333-3333-3333-333333333333', :'stage_lost', 'lost',
   8500, 0, '2024-09-30', :'user_id', :'user_id', 'lost',
...
-- - 10 deals ativos (R$ 918.000 total, ~R$ 590.000 esperado)
-- - 3 deals perdidos (R$ 101.500)
--
-- Win Rate esperado: 9/(9+3) = 75%
-- Ticket médio: R$ 417.500/9 = R$ 46.388
-- Pipeline ativo: R$ 918.000
--
-- Agora você pode testar:
-- 1. Dashboard Analytics (/dashboard/analytics)
-- 2. APIs de analytics (/api/analytics/*)
-- 3. Métricas de performance
-- 4. Forecast 3 meses
-- 5. Distribuição do pipeline
