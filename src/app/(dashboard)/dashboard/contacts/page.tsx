      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Card className="flex flex-col items-center justify-center py-12">
            ...
            <h3 className="text-lg font-medium">Nenhum contato encontrado</h3>
            <p className="text-muted-foreground text-sm mt-1">Tente ajustar sua busca ou filtros</p>
          </Card>
        </div>
      </div>
    );
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredContacts.map((contact) => (
          <ContactCard key={contact.id} contact={contact} onContactDeleted={handleContactDeleted} />
        ))}
      </div>
